...
/* package monadtrans-0.1.0.0 */
#ifndef VERSION_monadtrans
#define VERSION_monadtrans "0.1.0.0"
#endif /* VERSION_monadtrans */
#ifndef MIN_VERSION_monadtrans
#define MIN_VERSION_monadtrans(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_monadtrans */
...
#define CURRENT_COMPONENT_ID "monadtrans-0.1.0.0-KLKXqg8FXlW271UoKehlEi-monadtrans"
